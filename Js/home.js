...
//         }
//     }
//     return "404:error"; // Return an empty string if the user is not found
// }
...
//                     <span id="Comment${post.id}" onclick = "goToComments(Comment${post.id},${post.id})" style="color:#505050;cursor:pointer;"><i class="fa-regular fa-comment" style="color: #77767b;margin-right: 3px;"></i>Comments</span>
...
//                                             <i class="fa-regular fa-comment" style="color: #77767b;margin-right: 3px;"></i><span>Reply</span>
//                                         </span>
//                                     </div>
...
//                                                             <span style ="font-weight :normal;font-size:21px;color: #d83aa6;text-transform: capitalize;cursor:pointer" onclick = "userHTML(${reply.userId})">
//                                                                 ${findUserNameById(reply.userId)} 
//                                                             </span>   
//                                                             replied to <span onclick = "userHTML(${reply.userId})" style = "cursor:pointer;text-transform: capitalize">${findUserNameById(comment.userId)}</span>
//                                                         </span>
...
// function forSelectGroupInPost() {
//     var selectBox = document.getElementById("postGroupSelect");
//     const storedGroups = JSON.parse(localStorage.getItem("groups")) || [];
//     groups = storedGroups;
//     selectBox.innerHTML = '';
...
//         const option = `<option value="${groupId}">${groupName}</option>`;
...
//     const groupSelect = document.getElementById("postGroupSelect").value;
...
// //         if (post.postedIn == GroupId) {
// //             if (document.getElementById("HeaderForGroups")) {
// //                 document.getElementById("HeaderForGroups").remove();
// //             }
// //             const HeaderForGroups = document.createElement("section");

// //             const HeaderForGroupsHTML = `
// //                 <section>
// //                     <div style="display: flex; gap: 20px;">
// //                         <div id="logoForNeworkWall" style="width: 45px;height: 45px;border-radius: 50%;display: flex;justify-content: center;align-items: center;">
// //                             ${findGroupNameById(post.postedIn).charAt(0)}
// //                         </div>
// //                         <h3 style="font-weight: 100;color: #474747;display: flex;align-items: center;">
// //                             <a>${findGroupNameById(post.postedIn)}</a>
// //                         </h3>
// //                     </div>
// //                 </section>`
// //             HeaderForGroups.className = "HeaderForGroupsClass";
// //             HeaderForGroups.id = "HeaderForGroups"
// //             HeaderForGroups.innerHTML = HeaderForGroupsHTML;
// //             document.getElementById("myFeedsContentContainer").insertBefore(HeaderForGroups, document.getElementById("myFeedsContentBox"))
...
// //                         </div>
// //                         <div>
// //                             <span onclick = "userHTML(${userId})" style ="color: #373737c4;font-size: 17px;"><span style ="font-weight :600;font-size:21px;color: #d83aa6;text-transform: capitalize;" >${userName}</span> has started a conversation.</span></br>
// //                             <span style ="font-size: 16px;color: gray;">${formattedTimestampForPost}</span>
// //                         </div>
// //                     </div>
...
//     var menuBar = document.getElementById("homeOptionsContainer");
//     var burgerButton = document.getElementById("burgerButton");
//     var connectNameHome = document.getElementById("connectNameHome");
//     if(countForMenu % 2 === 0){
//         menuBar.style.position = `relative`;
//         menuBar.style.zIndex = `999`;
//         burgerButton.style.position = `relative`;
//         connectNameHome.style.position = `absolute`;
//         connectNameHome.style.top = `0px`;
//         connectNameHome.style.right = `0px`;
//     }
//     else{
//         menuBar.style.position = `unset`;
//         menuBar.style.zIndex = `100`;
//         burgerButton.style.position = `absolute`;
//         connectNameHome.style.position = `unset`;
//         // connectNameHome.style.top = `0px`;
//         // connectNameHome.style.right = `0px`;
//     }
//     countForMenu++;
...
function displayPosts() {
    ...
    for (let i = 0; i < storedPosts.length; i++) {
        ...
        const group = JSON.parse(localStorage.getItem("groups")).find(group => group.id == post.postedIn);
...
function suggestedGroups() {
    ...
    const suggestGroupMenuContent = document.getElementById("suggestGroupMenuContent"); 
    suggestGroupMenuContent.innerHTML = '';
    ...
    for (let i = 0; i < storedGroups.length; i++) {
        ...
        if (!group.members.includes(`${findUser()}`)) {
            ...
            groupElement.innerHTML = `
            <div class = "groupNames" style ="justify-content: space-between;cursor:pointer;"onclick="displayPostsByGroup(${groupId})">
                <a  class="avatar zc-light group-colorBg4" style="font-size: 17px;background-color: ${getColorForUser(groupId)};width: 45px;height: 45px;border-radius: 50%;display: flex; justify-content: center; align-items: center;">
                    <span>
                        ${group.name.charAt(0).toUpperCase()}
                    </span>
                </a>
            ...
            suggestGroupMenuContent.appendChild(groupElement);
        }
    }
}
// {<div class = "groupNames" style ="justify-content: space-between;">
// <a class="avatar zc-light group-colorBg4" style="font-size: 17px;background-color: ${getColorForUser(groupId)};width: 45px;height: 45px;border-radius: 50%;display: flex; justify-content: center; align-items: center;">
//     <span>
//         ${group.name.charAt(0).toUpperCase()}
//     </span>
...
// </div>
// <div style = "background-color: #fff; border: 1px solid #d83aa6; border-radius: 4px; padding: 6px 15px; text-align: center; cursor: pointer;min-width: 69px; max-width: 110px;">
//     <span style = "color:#d83aa6" onclick = "addUserToGroup(${findUser(),groupId})">
//         Join
//     </span>
// </div>}

// onclick="displayPostsByGroup(${groupId})" 
