...
//     var membersSectionTitle = document.getElementById("membersSectionTitle");
//     membersSectionTitle.innerText = `${findGrpNameById(groupHTMLId)}`
...
//         name: groupName,
//         description: description,
//         members: [finduserMailById(findUser())], // Add the creator as the first member
//         admin: [finduserMailById(findUser())],
//         posts: [],
//     };
...
// //         // If the group is found, and the user is not already a member
// //         if (group && !group.members.includes(email)) {
// //             group.members.push(email);
// //             users[email].groups.push(groupId);

// //             // Update group data in local storage
// //             localStorage.setItem("groups", JSON.stringify(groups));
...
//     var dropdownContainer = document.getElementById("membersSection").querySelector('.dropdown-container');
...
//     var totMember = dropdownList.querySelector('ul');
...
//         var eachMember = totMember.querySelectorAll('li');

//         if (!search) {
//             eachMember.forEach(function (item) {
...
//     totMember.addEventListener("change", function () {
//         var numChecked = totMember.querySelectorAll('[type="checkbox"]:checked').length;
//         quantitySpan.textContent = numChecked || 'Any';
//     });
//     var groupTotMem = [...(Object.keys(JSON.parse(localStorage.getItem("users")))).map(x => JSON.parse(localStorage.getItem("users"))[x].userId)].sort((a, b) => b - a);
//     var membersSectionMembersCount = document.getElementById("membersSectionMembersCount");
    
//     // Populate list 
//     for (const grp in JSON.parse(localStorage.getItem("groups"))) {
//         if (JSON.parse(localStorage.getItem("groups"))[grp].id == localStorage.getItem("groupHTMLId")) {
//             var theGroup = JSON.parse(localStorage.getItem("groups"))[grp]
//         }
//     }
//     let counter = 0;
//     console.log("Hello")
//     groupTotMem.forEach(function (userId) {
//         if (theGroup.members.includes(userId)) {
//             membersSectionMembersCount.innerText = `${++counter}`
//             var stateItem = document.createElement('li');
//             stateItem.style.display = `flex`;
//             stateItem.style.margin = `5px`;
//             stateItem.style.fontSize = `17px`;
//             stateItem.style.alignItems = `center`;
//             stateItem.innerHTML = `<div style ="display: flex;align-items:center;width:85%"><div class="profile-picture profile" id="userProfile" style ="background-color:${getColorForUser(userId)};margin-right: 25px">
//         <div id="profile-letter" class="profile-letter" onclick = "userHTML(${userId})" style="cursor:pointer">
//             ${findUserNameById(userId).charAt(0).toUpperCase()}
//         </div>
//     </div><span onclick = "userHTML(${userId})" style="cursor:pointer;text-transform: capitalize;"> ${findUserNameById(userId)}</span></div>`;

//             totMember.appendChild(stateItem);
//         }
...
// document.addEventListener("DOMContentLoaded", function () {
//     var membersSection = document.getElementById("adminSettings");
//     var dropdownContainer = membersSection.querySelector('.dropdown-container');
//     var dropdownList = dropdownContainer.querySelector('.dropdown-list');
//     var dropdownSearch = dropdownContainer.querySelector('.dropdown-search');
//     var totMember = dropdownList.querySelector('ul');
//     var quantitySpan = dropdownContainer.querySelector('.quantity');
...
//         </div>
//     </div><span onclick = "userHTML(${userId})" style="cursor:pointer;text-transform: capitalize;"> ${findUserNameById(userId)}</span></div>
//     <div><i class="fa-solid fa-user-plus" style="color: #1e3050;" onclick = "foraddUserToGroup(${userId},${localStorage.getItem("groupHTMLId")})"></i></div>
//     `;
...
// function foraddUserToGroup(userId,groupId){
//     addUserToGroup(userId.toString(),groupId.toString());
//     window.location.href = `groups.html`

// }
// function finduserMailById(userId) {
//     for (const us in JSON.parse(localStorage.getItem("users"))) {
//         if (JSON.parse(localStorage.getItem("users"))[us].userId == userId) {
//             return JSON.parse(localStorage.getItem("users"))[us].email
//         }
//         // console.log(JSON.parse(localStorage.getItem("users"))[us])
//     }
// }
...
//         // console.log("Hello")
//         // window.location.href = `membersGroup.html`
//         var membersSection = document.getElementById("membersSection");
//         var membersSectionBox = document.getElementById("membersSectionBox");
//         membersSection.style.display = "block";
//         membersSection.style.position = "absolute"
//         membersSection.style.height = "100vh";
//         membersSection.style.width = "100vw";
//         membersSection.style.backgroundColor = "rgba(52, 65, 79, 0.65)";
//         membersSection.style.top = "0";
//         membersSection.style.right = "0";
//         membersSection.style.zIndex = "10000";
//         membersSection.style.padding = "50px";


//         membersSectionBox.style.width = "700px";
//         membersSectionBox.style.color = "white";
//         membersSectionBox.style.margin = "0 auto 50px";
//         membersSectionBox.style.backgroundColor = "#fff";
//         membersSectionBox.style.height = "700px";
//         membersSectionBox.style.borderRadius = "5px";
//         membersSectionBox.style.margin = "0 auto 50px";
//         // var membersSectionTitle = document.getElementById("membersSectionTitle");
//         // membersSectionTitle
//         var membersSectionclose = document.getElementById("membersSectionclose");
//         membersSectionclose.addEventListener("click", () => {
...
// document.getElementById("groupsAdminSettings").addEventListener("click", () => {
//     var adminSettings = document.getElementById("adminSettings");
//     var adminSettingsBox = document.getElementById("adminSettingsBox");
//     adminSettings.style.display = "block";
//     adminSettings.style.position = "absolute"
//     adminSettings.style.height = "100vh";
//     adminSettings.style.width = "100vw";
//     adminSettings.style.backgroundColor = "rgba(52, 65, 79, 0.65)";
//     adminSettings.style.top = "0";
//     adminSettings.style.right = "0";
//     adminSettings.style.zIndex = "10000";
//     adminSettings.style.padding = "50px";


//     adminSettingsBox.style.width = "700px";
//     adminSettingsBox.style.color = "white";
//     adminSettingsBox.style.margin = "0 auto 50px";
//     adminSettingsBox.style.backgroundColor = "#fff";
//     adminSettingsBox.style.height = "700px";
//     adminSettingsBox.style.borderRadius = "5px";
//     adminSettingsBox.style.margin = "0 auto 50px";
//     var adminSettingsclose = document.getElementById("adminSettingsclose");
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    </div><span onclick = "userHTML(${userId})" style="cursor:pointer;text-transform: capitalize;"> ${findUserNameById(userId)}</span></div><div><span style = "color:#e4a918" id = "adminOrNot${userId}">ADMIN</span></div>`;

            totMember.appendChild(stateItem);
            var adminOrNot = document.getElementById(`adminOrNot${userId}`);
            if(theGroup.admin.includes(userId)){
                console.log(theGroup);
            }
            else{
                adminOrNot.style.display = `none`
            }
